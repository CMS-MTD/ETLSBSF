...
VoltageStep = -5
VoltageSettleTime = 60 #300#previously 10
MeasTimeInterval = 5 #Give an int, should be less than voltage settle time
InitialCurrentSettleTime = 60#2*60*60#1500#1000 #5000 # time before first run [s]
Compliance = 15e-06 # 2e-06#18e-06
